...
public class selectionSort_Tugas_2511533010 {
	    public void selectionSort_Tugas_2511533010(Mahasiswa_2511533010[] arr_3010) {
	        System.out.println("=== SELECTION SORT (Console) ===");
	        int n_3010 = arr_3010.length;
	        for (int i_3010 = 0; i_3010 < n_3010 - 1; i_3010++) {
	            int minIdx_3010 = i_3010;
	            for (int j_3010 = i_3010 + 1; j_3010 < n_3010; j_3010++) {
	                if (arr_3010[j_3010].getNama().compareToIgnoreCase(arr_3010[minIdx_3010].getNama()) < 0) {
	                    minIdx_3010 = j_3010;
	                }
	            }
	            Mahasiswa_2511533010 temp_3010 = arr_3010[minIdx_3010];
	            arr_3010[minIdx_3010] = arr_3010[i_3010];
	            arr_3010[i_3010] = temp_3010;
